...
from .const import (
    ...
    ATTR_LAST_CHECK,
    ATTR_LAST_RELOAD,
    ATTR_LISTENER_CALLBACK_REGISTERED,
    ATTR_LISTENER_COUNT,
    ATTR_LISTENER_EXPECTED,
    ATTR_LISTENER_FCM_TOKEN_PRESENT,
    ATTR_LISTENER_OWNED,
    ATTR_LISTENER_PRIVATE_HEALTH,
    ATTR_LISTENER_RECEIVER_PRESENT,
    ATTR_LISTENER_RECEIVER_TASK_STATE,
    ATTR_LISTENER_SESSION_TASK_STATE,
    ATTR_LISTENER_STARTED,
    ATTR_LISTENER_SUBSCRIBED,
    ATTR_REASON,
    ATTR_RELOAD_COUNT,
    ATTR_RING_ENTRY_ID,
...
class RingIntercomHealthEntity(CoordinatorEntity[RingIntercomHealthCoordinator]):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            ATTR_LISTENER_PRIVATE_HEALTH: data.listener_private_health,
            ATTR_LISTENER_SUBSCRIBED: data.listener_subscribed,
            ATTR_LISTENER_FCM_TOKEN_PRESENT: data.listener_fcm_token_present,
            ATTR_LISTENER_RECEIVER_PRESENT: data.listener_receiver_present,
            ATTR_LISTENER_RECEIVER_TASK_STATE: data.listener_receiver_task_state,
            ATTR_LISTENER_SESSION_TASK_STATE: data.listener_session_task_state,
            ATTR_LISTENER_CALLBACK_REGISTERED: data.listener_callback_registered,
