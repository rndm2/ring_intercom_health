...
CONF_SCHEDULED_RELOAD: Final = "scheduled_reload"
CONF_SCHEDULED_RELOAD_INTERVAL_SECONDS: Final = "scheduled_reload_interval_seconds"
...
DEFAULT_SCHEDULED_RELOAD: Final = False
DEFAULT_SCHEDULED_RELOAD_INTERVAL_SECONDS: Final = 86400
...
MIN_SCHEDULED_RELOAD_INTERVAL_SECONDS: Final = 3600
MAX_SCHEDULED_RELOAD_INTERVAL_SECONDS: Final = 604800
...
ATTR_LISTENER_PRIVATE_HEALTH: Final = "listener_private_health"
ATTR_LISTENER_SUBSCRIBED: Final = "listener_subscribed"
ATTR_LISTENER_FCM_TOKEN_PRESENT: Final = "listener_fcm_token_present"
ATTR_LISTENER_RECEIVER_PRESENT: Final = "listener_receiver_present"
ATTR_LISTENER_RECEIVER_TASK_STATE: Final = "listener_receiver_task_state"
ATTR_LISTENER_SESSION_TASK_STATE: Final = "listener_session_task_state"
ATTR_LISTENER_CALLBACK_REGISTERED: Final = "listener_callback_registered"
ATTR_RUNTIME_DATA_PRESENT: Final = "runtime_data_present"
ATTR_SCHEDULED_RELOAD: Final = "scheduled_reload"
ATTR_SCHEDULED_RELOAD_INTERVAL: Final = "scheduled_reload_interval_seconds"
ATTR_NEXT_SCHEDULED_RELOAD: Final = "next_scheduled_reload"
